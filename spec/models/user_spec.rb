...
RSpec.describe User, type: :model do
  describe "associations" do
    ...
    describe "today associations" do
      ...
      let!(:today_energy_level) { create :energy_level, user: user, created_at: Time.local(2018, 1, 1, 10) }
      let!(:yesterday_energy_level) { create :energy_level, user: user, created_at: Time.local(2018, 1, 2, 10) }
      let!(:another_energy_level) { create :energy_level, user: another_user, created_at: Time.local(2018, 1, 1, 10) }
